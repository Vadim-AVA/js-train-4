...
function padString(original, length, padWith, side) {
  ...
  switch (side) {
    case "start":
      string = original.padStart(length, padWith);
      break;
    case "end":
      string = original.padEnd(length, padWith);
      break;
    default:
      string = "Error: side should be either 'start' or 'end'";
  }
  return string;
}
...
function trimString(original, side) {
  ...
  switch (side) {
    case "start":
      string = original.trimLeft();
      break;
    case "end":
      string = original.trimRight();
      break;
    case "both":
      string = original.trim();
      break;
    default:
      string = "Error: side should be either 'start', 'end' or 'both'";
  }
  return string;
...
function convertCase(original, caseType) {
  ...
  switch (caseType) {
    case "upper":
      string = original.toUpperCase();
      break;
    case "lower":
      string = original.toLowerCase();
      break;
    default:
      string = "Error: caseType should be either 'upper' or 'lower'";
  }
  return string;
